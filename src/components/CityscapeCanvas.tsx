...
export function CityscapeCanvas() {
  ...
  useEffect(() => {
    ...
    const buildings: [number, number, number][] = [
      ...
      [836, H * 0.38, 28], [860, H * 0.55, 34], [890, H * 0.22, 24],
      [910, H * 0.46, 40], [946, H * 0.62, 22], [964, H * 0.28, 30],
      [990, H * 0.50, 36], [1022, H * 0.18, 22], [1040, H * 0.44, 44],
      [1080, H * 0.32, 26], [1102, H * 0.58, 30], [1128, H * 0.20, 38],
      [1162, H * 0.48, 24], [1182, H * 0.36, 22],
    ];
